...
class Builder(BlockFinder):
    ...
    def build_line(self):#??? Uses mc instance.
        print ("\nFUNCTION: build_line")
        if (self.delta_x!=0):
    ...
    def build_plane(self): #??? Uses mc instance.
    ...
    def build_hollow_cube(self): #??? Uses mc instance.
    ...
    def build_map1d(self):
        print ("\nFUNCTION: build_map1d")
        # WORKING

    def build_map2d(self): #??? Uses mc instance.
    ...
    def build_map3d(self): #??? Uses mc instance.
